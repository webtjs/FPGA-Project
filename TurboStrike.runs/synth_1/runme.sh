...
HD_PWD='D:/Desktop/TurboStrike-FPGA-Project/TurboStrike.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log turbostrike.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source turbostrike.tcl
