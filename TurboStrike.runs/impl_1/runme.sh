...
HD_PWD='D:/Desktop/TurboStrike-FPGA-Project/TurboStrike.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log turbostrike.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source turbostrike.tcl -notrace
